...
- **[{{ project.title }}]({{ project.link }})** [![Stars](https://img.shields.io/github/stars/{{ repo_path }}?style=flat-square&label=%E2%98%85&color=dfb317&cacheSeconds=86400)]({{ project.link }}/stargazers): {{ project.description }}
{% endfor %}
